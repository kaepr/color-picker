...
const LabelName = ({ name, id }) => {
  ...
  return (
    <div className="font-light p-1 hover:border-black">
      <input
        className="appearance-none rounded-md focus:outline-none focus:ring focus:border-blue-300 cursor-pointer border-none p-1 text-grey-darkest w-full bg-gray-100 mb-1"
        value={colorLabel}
